...
set(LIEF_VERSION 9cf3b56cf004407c56695a61688ecc8ac511ef0e)
...
set(FILESYSTEM_URL "https://github.com/gulrak/filesystem.git")
set(FILESYSTEM_VERSION cd6805e94dd5d6346be1b75a54cdc27787319dd2)


FetchContent_Declare(${FILESYSTEM}
    GIT_REPOSITORY ${FILESYSTEM_URL}
    GIT_TAG        ${FILESYSTEM_VERSION}
    UPDATE_DISCONNECTED ON
)


FetchContent_MakeAvailable(${ASMJIT} ${LIEF} ${CATCH2} ${FILESYSTEM})

# Target libraries to link
set(LIB_LIEF    LIB_LIEF)
set(LIB_ASMJIT  asmjit)
set(LIB_CATCH2  Catch2)
set(LIB_FS      ghc_filesystem)
