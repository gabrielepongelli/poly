...
namespace poly {
    ...
    template <class Real>
    Address
    CommonBinaryEditor<Real>::align_to_page_size(Address addr,
    ...
    template <class Real>
    inline Address CommonBinaryEditor<Real>::text_section_va() const noexcept {
    ...
    template <class Real>
    Error
    CommonBinaryEditor<Real>::update_content(const std::string &name,
                                             const RawCode &content) noexcept {
        if (!ProtectedAccessor::has_section(*this->real(), name))
            return Error::kSectionNotFound;
    ...
    template <class Real>
    bool CommonBinaryEditor<Real>::save_changes(std::ostream &dst) noexcept {
    ...
    template <class Real>
    inline const impl::OsSection *
    CommonBinaryEditor<Real>::ProtectedAccessor::get_section(
        const Real &real, const std::string &name) noexcept {
        constexpr const impl::OsSection *(Real::*fn)(const std::string &)
    ...
    CommonBinaryEditor<Real>::ProtectedAccessor::get_text_section(
        Real &real) noexcept {
        constexpr impl::OsSection &(Real::*fn)() noexcept =
    ...
    CommonBinaryEditor<Real>::ProtectedAccessor::get_text_section(
        ...
        constexpr const impl::OsSection &(Real::*fn)() const noexcept =
            &ProtectedAccessor::get_text_section_impl;
    ...
    template <class Real>
    inline impl::OsBinary &
    CommonBinaryEditor<Real>::ProtectedAccessor::get_bin(Real &real) noexcept {
        constexpr impl::OsBinary &(Real::*fn)() noexcept =
    ...
    template <class Real>
    inline const impl::OsBinary &
    CommonBinaryEditor<Real>::ProtectedAccessor::get_bin(
        const Real &real) noexcept {
        constexpr const impl::OsBinary &(Real::*fn)() const noexcept =
            &ProtectedAccessor::get_bin_impl;
