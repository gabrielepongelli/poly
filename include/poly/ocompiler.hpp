...
namespace poly {
    ...
    namespace impl {
        ...
        //! members, this class represents a different interpretation of the
        //! same data.
        //!
        union Operand {
            asmjit::Operand op;
        ...
        class OperationNode : public SpecializedTreeNode<Operation *> {
          public:
            ...
            //!
            //! Change the operation represented by this node.
            //! \note: the old operation will be destroied.
            ...
            //!
            //! Iterate over all the OperationNodes of a tree and process each
            //! of them. The visit will be performed post-order.
            //! \param root root of the tree to process.
            //! \param process function used to process each OperationNode of
            //! the tree. The node to process will be passed by argument to the
            //! function.
            //!
        ...
        //!
        //! Class which add the capability to perform obfuscated "not"
        ...
        //!
        //! Class which add the capability to perform obfuscated "and"
        //! operations applied to a type T. The Derived class must implement the
        //! following method:
        //!      ```static void expand(
        //!          T, asmjit::Operand, Operation *, Compiler &) noexcept```
        ...
        //!
        //! Class which add the capability to perform obfuscated "xor"
        //! operations applied to a type T. The Derived class must implement the
        //! following method:
        //!      ```static void expand(
        //!          T, asmjit::Operand, Operation *, Compiler &) noexcept```
        ...
        //!
        //! Class which add the capability to perform obfuscated "sum"
        //! operations applied to a type T. The Derived class must implement the
        //! following method:
        //!      ```static void expand(
        //!          T, asmjit::Operand, Operation *, Compiler &) noexcept```
        ...
        //!
        //! Class which add the capability to perform obfuscated
        //! "multiplication" operations applied to a type T. The Derived class
    ...
    //!
    //! This is a compiler which can be used as a normal Compiler. When the code
    //! will be serialized this compiler will perform some obfuscations to make
    //! it less readable and understandable.
    //!
